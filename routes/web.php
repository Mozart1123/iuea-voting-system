...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('dashboard')->name('dashboard')->group(function () {
        ...
        Route::get('/live-results', [StudentController::class, 'liveResults'])->name('.live-results');
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        // Winners & Finalization
        Route::get('/winners', [AdminController::class, 'winners'])->name('winners');
        Route::post('/finalize-vote', [AdminController::class, 'finalizeVote'])->name('finalize-vote');
    });
