            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <span class="text-sm font-semibold text-gray-800 ml-2 bg-gray-100 px-3 py-1 rounded-full">2025 Elections</span>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-4 relative" id="userDropdownContainer">
                    ...
                    <button id="userMenuBtn" class="w-11 h-11 rounded-full bg-gradient-to-br from-[#8B0000] to-[#B22222] flex items-center justify-center text-white font-bold text-lg ring-2 ring-white shadow-md focus:outline-none">
                        {{ $initials }}
                    </button>
