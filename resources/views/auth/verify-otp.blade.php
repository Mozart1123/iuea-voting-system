...
<head>
    ...
    <title>IUEA GuildVote – OTP Verification</title>
...
<body class="min-h-screen flex flex-col md:flex-row antialiased">
    ...
    <div class="md:w-1/2 gradient-left text-white flex flex-col justify-between p-8 md:p-12 relative overflow-hidden">
        <div class="relative z-10">
            ...
            <h1 class="text-3xl md:text-4xl font-bold leading-tight mb-6">Secure Your Account</h1>
            <p class="text-white/80 text-lg">A verification code has been sent to your Gmail account.</p>
        </div>
        <div class="relative z-10 text-white/60 text-sm mt-12">© 2026 IUEA – Secure Voting</div>
    </div>
    ...
    <div class="md:w-1/2 bg-white flex items-center justify-center p-6 md:p-10">
        <div class="w-full max-w-md text-center">
            <div class="mb-8">
                ...
                <p class="text-gray-500">Enter the 6-digit code received by email.</p>
            </div>
            ...
            <form action="{{ route('otp.resend') }}" method="POST" class="mt-8">
                ...
                <p class="text-gray-600 text-sm">
                    ...
                    <button type="submit" class="font-semibold text-primary hover:underline transition">Resend by email</button>
                </p>
            </form>
        </div>
    </div>
